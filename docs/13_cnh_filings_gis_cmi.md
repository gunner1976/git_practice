...
- Per-well monthly volumes after Nov 2019 sit in the "Anexo I. Formatos mensuales" zip attachments of the measurement reports (VHP format, "volumen de producción extraído de los pozos Tecolutla-10 DES y Tecolutla-2"), which are not on the Drive as loose files. G-32 stays open for the well split, but the field-level answer now exists for 2020–2022.
